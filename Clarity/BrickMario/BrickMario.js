...
BrickMario.prototype.error = function (message) {

    if (this.alert_errors) alert(message);
    if (this.log_info) console.log(message);
};

BrickMario.prototype.log = function (message) {

    if (this.log_info) console.log(message);
};

BrickMario.prototype.set_viewport = function (x, y) {

    this.viewport.x = x;
    this.viewport.y = y;
};

BrickMario.prototype.keydown = function (e) {
...
BrickMario.prototype.keyup = function (e) {
...
BrickMario.prototype.load_map = function (map) {
    ...
    this.tile_size = map.tile_size || 20;
...
BrickMario.prototype.get_tile = function (x, y) {

    return (this.current_map.data[y] && this.current_map.data[y][x]) ? this.current_map.data[y][x] : 0;
};

BrickMario.prototype.draw_tile = function (x, y, tile, context) {
...
BrickMario.prototype.draw_map = function (context, fore) {
...
BrickMario.prototype.move_player = function () {
...
BrickMario.prototype.update_player = function () {
...
BrickMario.prototype.draw_player = function (context) {
...
BrickMario.prototype.update = function () {

    this.update_player();
};

BrickMario.prototype.draw = function (context) {
